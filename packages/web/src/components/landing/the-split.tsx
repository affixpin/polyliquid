    ...
    <section className="max-w-[1140px] mx-auto px-8 py-16">
        ...
        <Card className="bg-surface border-border py-0 gap-0 overflow-hidden relative group hover:border-danger/20 transition-colors">
          ...
          <CardContent className="p-6">
            ...
            <div className="space-y-3.5">
              ...
              <CompRow label="Consequence of attack" uma="Sell tokens, keep profit" />
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="bg-surface border-border py-0 gap-0 overflow-hidden relative group hover:border-brand/20 transition-colors">
          ...
          <CardContent className="p-6">
            ...
            <div className="space-y-3.5">
              ...
              <CompRow label="Consequence of attack" poly="Lose all stake + reputation" />
            </div>
          </CardContent>
        </Card>
      </div>
      ...
      <Card className="bg-brand/8 border-brand/15 py-0 gap-0">
        <CardContent className="px-6 py-4 flex items-center justify-between">
          ...
          <div className="font-mono text-[36px] font-extrabold tracking-tight bg-gradient-to-br from-brand-bright to-success bg-clip-text text-transparent shrink-0 ml-8">
            14,700&times;
          </div>
        </CardContent>
      </Card>
...
function CompRow({
  ...
  return (
    <div className="flex justify-between items-start gap-4">
      <span className="text-[12px] text-text-3 shrink-0 w-[140px]">{label}</span>
      <span
