  ...
  return (
    <>
      <section className="bg-[var(--navy-alt)]">
        <div className="text-center py-12 md:py-16 px-4 md:px-8 max-w-[1140px] mx-auto">
      ...
      <footer className="flex justify-center items-center px-4 md:px-8 py-4 font-mono text-[11px] text-text-3">
